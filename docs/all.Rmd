...
We performed differential abundance analysis on these k-mers and found that XX% are decreased in IBD, particularly in CD. 
...
While many of the k-mers in the less abundant fractions from these genomes annotate to marker genes, the more abundant k-mers annotate to metabolic pathways like starch and sucrose metabolism or flagellar assembly (**Figure \ref{fig:hashcontent}**).
...
To fully characterize the fraction of the pangenomes of these four strains that are more abundant IBD, we generated pangenomes via assembly, clustering, and annotation of all genes in the assembly graph neighborhood of each strain.
...
However, many genes that anchor k-mers, particularly those that are more abundant in *Flavonifractor*, are not statistically significantly different in CD or UC after bonferroni p-value correction. 
Even still, we detect many significantly differentially abundant genes among these strains.
...
<!-- This supports results from our k-mer analysis, in which *F. gnavus* is different from nonIBD in CD alone. -->
Of differentially abundant genes, 3,041 were more abudant in CD than nonIBD. 
We performed KEGG enrichment analysis the KEGG orthologs that were annotated only as more abundant in CD.

A recent study found that one clade of *F. gnavus* is enriched in CD [@hall2017], and that this clade produces a polysaccharide that induced intestinal inflammation [@henke2019ruminococcus].
We investigated whether the gene cluster involved in biosynthesis of the inflammatory polysaccharide was significantly more abundant in CD. 
...
We compared our results against a study of virulence-causing genes in *C. bolteae* [@lozupone2012identifying], and find that 24 of 41 previously identified orthologs are significantly induced in CD. 
